...
### Compute types
The engineer can choose the compute type for each job. There are 4 different compute types are present: Fargate and EC2 and Fargate Spot and EC2 Spot. Changing compute type is as simple as specifying this in the API call to execute the job.